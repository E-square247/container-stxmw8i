...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-stxmw8i.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-stxmw8i.containers.anotherwebservice.com/
...
```
git clone git@github.com:E-square247/container-stxmw8i.git
cd container-stxmw8i
```
...
```
docker attach container-stxmw8i
```
